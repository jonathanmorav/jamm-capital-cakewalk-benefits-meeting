    ...
    >
      <header className="mx-auto mb-4 w-full max-w-4xl text-left md:text-center">
        ...
        <p className="mt-2 text-xs text-brand-gray/80 md:text-sm">
          Projections below reflect Cakewalk&apos;s base case with <span className="font-semibold text-brand-darkBlue/80">zero health plan attachment</span>; incremental health revenue is explored in the sensitivity model.
        </p>
      </header>
        ...
        <Table>
          ...
          <TableBody>
            ...
            <TableRow className="bg-brand-lightMint/20 hover:bg-brand-lightMint/30">
              ...
              <TableCell className="text-right font-semibold tabular-nums text-brand-darkBlue">25,000</TableCell>
              <TableCell className="text-right font-semibold tabular-nums text-brand-darkBlue">50,000</TableCell>
            </TableRow>
            <TableRow className="hover:bg-brand-lightMint/10">
            ...
            <TableRow className="hover:bg-brand-lightMint/10">
              ...
              <TableCell className="text-right tabular-nums text-brand-darkBlue/90">$37.5M</TableCell>
              <TableCell className="text-right tabular-nums text-brand-darkBlue/90">$75.0M</TableCell>
            </TableRow>
            ...
            <TableRow className="bg-soft-blue/20 hover:bg-soft-blue/30">
              ...
              <TableCell className="text-right font-semibold tabular-nums text-brand-darkBlue">$0.7M</TableCell>
              <TableCell className="text-right font-semibold tabular-nums text-brand-darkBlue">$9.4M</TableCell>
              <TableCell className="text-right font-semibold tabular-nums text-brand-darkBlue">$18.8M</TableCell>
            </TableRow>
            <TableRow className="hover:bg-brand-lightMint/10">
